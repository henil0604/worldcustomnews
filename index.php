...
<head>
    ...
    <title>Home - World Custom News</title>
...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark bg-dark" style="width: 100%;">
        <img src="worldNewsLogo2.png" class="d-inline-block align-top" id="worldNewsLogo" alt="World News">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button class="btn btn-outline-warning my-2 my-sm-0" onclick="location.href = 'whatsNew.html'"" type=" button">What's New?</button>
        </div>
    </nav>
    <br>
        ...
        <div class="Imformation">
            <form method="POST">
                <div class="Country my-2" id="Country">
                    <h4>Country:</h4>
                    <select class="country-input" name="country" id="country-input">
                ...
                <div class="Catagory my-2">
                    <h4>Catagory:</h4>
                    <select class="catagory-input" name="catagory" id="catagory-input">
                ...
                <br>
                <button class="btn btn-primary my-2" type="submit" name="submit" accesskey="G" onclick="newsResponse()">Get
                    News</button>
            </form>
        </div>
        <br><br>
...
if (isset($_POST['submit'])) {
    ...
    if (!$con) {
        ...
        $sql = "INSERT INTO `worldcustomnews`.`worldcustomnews` (`Country`, `Catagory`, `dt`) VALUES ('$country', '$catagory', current_timestamp())";
        $con->close();
    }
}
